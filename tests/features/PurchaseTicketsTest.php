...
class PurchaseTicketsTest extends TestCase
{
    ...
    /** @test */
    function customer_can_purchase_tickets_to_a_published_concert_tickets()
    {
    ...
    /** @test */
    function cannont_purchase_tickets_another_customer_is_already_trying_to_purchase() {
        $this->disableExceptionHandling();
        ...
        $this->paymentGateway->beforeFirstCharge(function ($paymentGateway) use ($concert) {
            ...
            $this->assertResponseStatus(422);
            $this->assertFalse($concert->hasOrderFor('personB@example.com@example.com'));
            $this->assertEquals(0, $this->paymentGateway->totalCharges());
        });
